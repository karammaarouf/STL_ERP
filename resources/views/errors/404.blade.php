        ...
        <div class="container">
          <div class="error-page1">
            ...
            <div class="col-md-8 offset-md-2">
              ...
              <p class="sub-content">{{ __('The page you are attempting to reach is currently not available. This may be because the page does not exist or has been moved.') }}</p><a class="btn btn-primary btn-lg" href="{{ route('dashboard') }}">{{ __('BACK TO HOME PAGE') }}</a>
            </div>
          </div>
        </div>
      </div>
